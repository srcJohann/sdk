...
# ============================================================================
start_server() {
    echo -e "${YELLOW}[2/2]${NC} Iniciando servidor FastAPI com RBAC..."
    echo ""
    echo -e "${BLUE}╔════════════════════════════════════════════════════════════════╗${NC}"
    ...
    #!/bin/bash
# ==============================================================================
# Entrypoint para Backend FastAPI (server_rbac.py)
# ==============================================================================
# Responsabilidades:
# 1. Aguardar PostgreSQL estar disponível
# 2. Iniciar servidor FastAPI com RBAC
#
# ==============================================================================
...
start_server() {
    ...
    # Iniciar servidor via server_rbac
